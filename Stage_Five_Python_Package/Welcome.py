...
def Introduction():
    ...
    print("首先，通过简单的 Python 爬虫 从k站（著名二次元图片网站） 'https://konachan.net/post' 抓取并下载二次元图片")
...
def GetRequirement():
    ...
    print("    1.从k站的推荐中下载图片\n    2.输入动漫人物名称进行检索并下载\n    3.检索并下载动漫人物 ' 雪之下雪乃 ' 图片")
    Status = int(input())
    if Status == 2:
        print("请问您想下载哪位动漫人物的图片呢？\n（支持中文、日文或英文输入）\n（例如：雪之下雪乃/ゆきのした ゆきの/Yukinoshita Yukino）")
        Tag = FindTag.FindTag(input())
